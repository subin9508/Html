...
<body>
    ...
    <main>
        ...
        o. JSP 태그를 제외한  JSP 모든 코드 안에서는 언제든지 사용할 수 있음.
            ...
            - CSS 속성 값 설정
            - HTML 안에 <script> 태그에 포함된 JavaScript 코드 안에서 사용할 수 있음.
            - JSTL 안에서 사용 가능
         --%>
         ...
         o. 상태 저장 메서드: setAttribute("속성이름", 속성값(타입 상관 없음))
         o. 저장된 상태 값을 읽는 메서드: getAttribute("속성이름") 
          --%>
