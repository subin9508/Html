 ...
 */
 ...
 // document.getElementById('btn1')도 가능.
 ...
 // button#btn2인 요소를 찾음. document.getElementById('btn2')도 가능.
 ...
 // parent > child (부모의 바로 아래 쪽에 있는 element)
 // ancestor descendent (2단계, 3단계, ... 아래에 있는 element 모두)
